 ...
 * @author Lalit
 */
public class ChangeEmpPassw extends javax.swing.JInternalFrame {
    ...
    public ChangeEmpPassw(Connection c, String uname) {
        this.conn = c;
        this.username = uname;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(cpanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 890, 670));
    ...
    private void btnChangeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChangeActionPerformed
        ...
        try {
            ...
            if (newPassw.equals(confirmPassw)) {
                sql = "select passw from emplogin where username=?";
                ...
                if (oldp.equals(oldPassw)) {
                    sql = "update emplogin set passw=? where username=?";
                    ps = conn.prepareStatement(sql);
